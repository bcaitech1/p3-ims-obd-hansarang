...
model = dict(
    pretrained='/home/ubuntu/CUAI_2021/Advanced_Won_Cho/code/Swin-Transformer-Object-Detection/work_dirs/swin+cascade/swin_small_patch4_window7_224.pth',
    backbone=dict(
        embed_dim=96,
        depths=[2, 2, 18, 2],
        num_heads=[3, 6, 12, 24],
             ...
             [
                 dict(type='Resize',
                      img_scale=[(480, 512), (512, 512), (544, 512), (576, 512),
                                 ...
                                 (736, 512), (256, 256), (192,192)],
                      multiscale_mode='value',
                      keep_ratio=True)
             ],
             [
                 dict(type='Resize',
                      img_scale=[(400, 512), (500, 512), (600, 512)],
                      multiscale_mode='value',
                      keep_ratio=True),
