model = dict(
    ...
    rpn_head=dict(
        ...
        anchor_generator=dict(
            ...
            scales=[8, 16],
            ratios=[0.5, 0.33, 1.0, 1.5, 2.0, 3.0],
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            mask_thr_binary=0.5)),
    pretrained=
    '/opt/ml/code/mmdetection_trash/configs/_base_/swin_weights/swin_base_patch4_window7_224.pth'
)
...
data = dict(
    ...
    test=dict(
        ...
        classes=('UNKNOWN', 'General trash', 'Paper', 'Paper pack', 'Metal',
                 'Glass', 'Plastic', 'Styrofoam', 'Plastic bag', 'Battery',
                 'Clothing'),
        ann_file='/opt/ml/input/data/test_private.json',
        img_prefix='/opt/ml/input/data/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(project='Default', name='Default'))
    ])
log_config2 = dict()
custom_hooks = [dict(type='NumClassCheckHook')]
dist_params = dict(backend='nccl')
log_level = 'INFO'
load_from = '/opt/ml/code/mmdetection_trash/work_dirs/swin/cascade_mask_rcnn_swin_base_patch4_window7.pth'
resume_from = None
workflow = [('train', 1)]
work_dir = '/opt/ml/code/mmdetection_trash/work_dirs/swin'
gpu_ids = range(0, 1)
