model = dict(
    type='CascadeRCNN',
    pretrained=
    '/opt/ml/code/mmdetection_trash/configs/_base_/swin_weights/swin_small_patch4_window7_224.pth',
    backbone=dict(
...
train_pipeline = [
    ...
    dict(
        ...
        policies=[[{
            'type':
            'Resize',
            'img_scale': [(480, 480), (512, 512), (544, 544), (608, 608),
                          (640, 640), (672, 672), (736, 736), (768, 768),
                          (800, 800)],
            'multiscale_mode':
            'value',
            'keep_ratio':
